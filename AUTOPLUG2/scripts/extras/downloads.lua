...
function downloads()
	...
	local FastReset_callback = function ()
		download_install("https://github.com/hedhehd/Fastreset-2.0.vpk-by-SilicaandPina/releases/latest/", "fastreset-2.0.vpk")
	end
	...
	local menu = {
		...
		{ text = LANGUAGE["MENU_EXTRAS_INSTALL_FASTRESET"],	desc = LANGUAGE["MENU_EXTRAS_INSTALL_FASTRESET_DESC"],  	funct = FastReset_callback },
